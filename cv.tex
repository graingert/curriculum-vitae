...
\cventry{July 2013 - Current}{Python Developer}{Hogarth Worldwide, Technology Services Department}{}{}{
  django-tastypie, REST.
  Desgined and implimented a replacement integration system with the enterprise systems Maconomy and Odystar
  Used Selenium to verify and test the system.
  Split a large Django application into smaller, manageable Python packages. Wheel.
}
